...
set_clock_groups -asynchronous -group [get_clocks {clock_108m clock_54m clock_VideoDHClk clock_VideoDLClk clock_27m }] -group [get_clocks {clock_reset }] 
...
// (ENABLE_SOUND constraints removed: DIAG_SLIM build has no PSG/OPLL)
