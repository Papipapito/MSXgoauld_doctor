...
add_file msx_debug/diag_macros.v
add_file msx_debug/diag_rom.v
...
set_option -use_sspi_as_gpio 1 -use_mspi_as_gpio 1 -top_module top -verilog_std sysv2017 -include_path src -place_option 1 -route_option 1
run syn
run pnr
